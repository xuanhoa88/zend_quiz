...
(function(factory) {
    ...
    var settings = {
        ...
        options: {
            ...
            onSelectFromFiles: null, // select from files
            onToolbarClick: null,
            onsubmit: null,
    ...
    var Editor = function() {
        ...
        this.insertImage = function($editable, sUrl, filename) {
            ...
            async.createImage(sUrl, filename).then(function($image) {
                ...
                $self.insertNode($editable, $image[0]);
            });
        };
        ...
        this.insertNode = function($editable, node) {
            beforeCommand($editable);
            this.createRange($editable).insertNode(node);
                    ...
                    $imageBtn.click(function(event) {
                        ...
                        if ($(event.target).hasClass('note-group-select-from-files')) {
                            if (callbacks.onSelectFromFiles) {
                                callbacks.onSelectFromFiles(editor, $editable, 'image');
                            }
                        } else {
    ...
    var EventHandler = function() {
        ...
        var commands = {
            ...
            showImageDialog: function(layoutInfo) {
                ...
                editor.saveRange($editable);
                dialog.showImageDialog($editable, $dialog, self.getEditor()).then(function(data) {
                    editor.restoreRange($editable);
        ...
        this.attach = function(layoutInfo, options) {
            ...
            layoutInfo.editable.data('callbacks', {
                ...
                onSelectFromFiles: options.onSelectFromFiles
            });
        };
        ...
        var tplDialogInfo = {
            image: function(lang, options) {
                ...
                var body = '<div class="form-group row-fluid">' +
                	'<button href="#" class="btn btn-primary note-image-btn note-group-select-from-files">' + lang.image.selectFromFiles + '</button>' +
                	'</div>' + 
